...
!....
      call measure ( 2, ' ', 9 )
      call shiftz( physval1, 6, llx+1, lly+1, llz+1, -1 )
      call measure ( 3, ' ', 9 )
!....
...
!....                                             * calc. g(i)(j,k,l) *
      call measure ( 2, ' ', 9 )
!$OMP MASTER
      call shiftz( physval3, 5, llx+1, lly+1, llz+1, 1 )
!$OMP END MASTER
!$OMP BARRIER
      call measure ( 3, ' ', 9 )
!....
...
!....
      call measure ( 2, ' ', 9 )
!$OMP MASTER
      call shiftz( physval4, 8, llx+1, lly+1, llz+1, -1 )
!$OMP END MASTER
!$OMP BARRIER
      call measure ( 3, ' ', 9 )
!....
...
!....
      call measure ( 2, ' ', 9 )
!$OMP MASTER
      call shiftz( physval5, 5, llx+1, lly+1, llz+1, 1 )
!$OMP END MASTER
!$OMP BARRIER
      call measure ( 3, ' ', 9 )
!....                                                     * advance z *
