...
!....
      call measure ( 2, ' ', 8 )
      call shifty( physval1, 6, llx+1, lly+1, llz+1, -1 )
      call measure ( 3, ' ', 8 )
!....
!$OMP PARALLEL FIRSTPRIVATE(wra2) PRIVATE(iys,iye, &
...
!....
      call measure ( 2, ' ', 8 )
!$OMP MASTER
      call shifty( physval3, 5, llx+1, lly+1, llz+1, 1 )
!$OMP END MASTER
!$OMP BARRIER
      call measure ( 3, ' ', 8 )
!....                                             * calc. g(i)(j,k,l) *
...
!....
      call measure ( 2, ' ', 8 )
!$OMP MASTER
      call shifty( physval4, 8, llx+1, lly+1, llz+1, -1 )
!$OMP END MASTER
!$OMP BARRIER
      call measure ( 3, ' ', 8 )
!....
...
!....
      call measure ( 2, ' ', 8 )
!$OMP MASTER
      call shifty( physval5, 5, llx+1, lly+1, llz+1, 1 )
!$OMP END MASTER
!$OMP BARRIER
      call measure ( 3, ' ', 8 )
!....                                                     * advance y *
