...
!....
      call measure ( 2, ' ', 7 )
! !$XMP REFLECT(sr,sm,sn,sl,se,sp)
!$XMP REFLECT (physval1)
      call measure ( 3, ' ', 7 )
!....
!$XMP LOOP (iz) ON t(*,*,iz)
...
!....
      call measure ( 2, ' ', 7 )
! !$XMP REFLECT(walfa1,walfa2,walfa3,walfa4,walfa5)
!$XMP REFLECT (physval3)
      call measure ( 3, ' ', 7 )
!....                                             * calc. g(i)(j,k,l) *
!$XMP LOOP (iz) ON t(*,*,iz)
!$OMP PARALLEL DO SCHEDULE(STATIC) PRIVATE(iy,ix)
...
!....
      call measure ( 2, ' ', 7 )
! !$XMP REFLECT(wg1,wg2,wg3,wg4,wg5)
! !$XMP REFLECT(wtmp1,wtmp2,wtmp3)
!$XMP REFLECT (physval4)
      call measure ( 3, ' ', 7 )
!....
!$XMP LOOP (iz) ON t(*,*,iz)
! !$OMP PARALLEL DO SCHEDULE(STATIC) &
...
!....
      call measure ( 2, ' ', 7 )
! !$XMP REFLECT(wff1,wff2,wff3,wff4,wff5)
!$XMP REFLECT (physval5)
      call measure ( 3, ' ', 7 )
!....                                                     * advance z *
!$XMP LOOP (iz) ON t(*,*,iz)
!$OMP PARALLEL DO SCHEDULE(STATIC) PRIVATE(iy,ix)
