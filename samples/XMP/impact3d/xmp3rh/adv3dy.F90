...
!....
      call measure ( 2, ' ', 8 )
! !$XMP REFLECT(sr,sm,sn,sl,se,sp) width(0,0:1,0)
!$XMP REFLECT (physval1) width(0,0,0:1,0)
      call measure ( 3, ' ', 8 )
!....
...
!....
      call measure ( 2, ' ', 8 )
! !$XMP REFLECT(walfa1,walfa2,walfa3,walfa4,walfa5) width(0,1:0,0)
!$XMP REFLECT (physval3) width(0,0,1:0,0)
      call measure ( 3, ' ', 8 )
!....                                             * calc. g(i)(j,k,l) *
!$XMP LOOP (ix,iy,iz) ON t(ix,iy,iz)
!$OMP PARALLEL DO SCHEDULE(STATIC) PRIVATE(iy,ix)
...
!....
      call measure ( 2, ' ', 8 )
! !$XMP REFLECT(wg1,wg2,wg3,wg4,wg5) width(0,0:1,0)
! !$XMP REFLECT(wtmp1,wtmp2,wtmp3) width(0,0:1,0)
!$XMP REFLECT (physval4) width(0,0,0:1,0)
      call measure ( 3, ' ', 8 )
!....
!$XMP LOOP (ix,iy,iz) ON t(ix,iy,iz)
! !$OMP PARALLEL DO SCHEDULE(STATIC) &
...
!....
      call measure ( 2, ' ', 8 )
! !$XMP REFLECT(wff1,wff2,wff3,wff4,wff5) width(0,1:0,0)
!$XMP REFLECT (physval5) width(0,0,1:0,0)
      call measure ( 3, ' ', 8 )
!....                                                     * advance y *
!$XMP LOOP (ix,iy,iz) ON t(ix,iy,iz)
!$OMP PARALLEL DO SCHEDULE(STATIC) PRIVATE(iy,ix)
