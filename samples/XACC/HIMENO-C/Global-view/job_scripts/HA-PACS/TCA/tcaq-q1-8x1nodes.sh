...
#PBS -A XMPTCA
#PBS -q tcaq-q1
#PBS -l select=1:ncpus=1:host=tcag-0002-eth0+1:ncpus=1:host=tcag-0004-eth0+1:ncpus=1:host=tcag-0006-eth0+1:ncpus=1:host=tcag-0008-eth0+1:ncpus=1:host=tcag-0016-eth0+1:ncpus=1:host=tcag-0014-eth0+1:ncpus=1:host=tcag-0012-eth0+1:ncpus=1:host=tcag-0010-eth0
