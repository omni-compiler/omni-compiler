...
extern char *strptime ( char * __s,
		        char * __fmt, struct tm *__tp)
     __THROW;
# endif
...
extern char *strptime_l ( char * __s,
			  char * __fmt, struct tm *__tp,
			 __locale_t __loc) __THROW;
# endif
...
extern struct tm *gmtime ( time_t *__timer) __THROW;

/* Return the `struct tm' representation
   of *TIMER in the local timezone.  */
extern struct tm *localtime ( time_t *__timer) __THROW;
__END_NAMESPACE_STD

# if defined __USE_POSIX || defined __USE_MISC
/* Return the `struct tm' representation of *TIMER in UTC,
   using *TP to store the result.  */
extern struct tm *gmtime_r ( time_t * __timer,
			    struct tm * __tp) __THROW;

/* Return the `struct tm' representation of *TIMER in local time,
   using *TP to store the result.  */
extern struct tm *localtime_r ( time_t * __timer,
			       struct tm * __tp) __THROW;
# endif	/* POSIX or misc */
...
extern char *asctime ( struct tm *__tp) __THROW;

/* Equivalent to `asctime (localtime (timer))'.  */
extern char *ctime ( time_t *__timer) __THROW;
__END_NAMESPACE_STD
...
/* Return in BUF a string of the form "Day Mon dd hh:mm:ss yyyy\n"
   that is the representation of TP in this format.  */
extern char *asctime_r ( struct tm * __tp,
			char * __buf) __THROW;

/* Equivalent to `asctime_r (localtime_r (timer, *TMP*), buf)'.  */
extern char *ctime_r ( time_t * __timer,
		      char * __buf) __THROW;
# endif	/* POSIX or misc */
...
extern int stime ( time_t *__when) __THROW;
# endif
...
extern int getdate_r ( char * __string,
		      struct tm * __resbufp);
# endif
