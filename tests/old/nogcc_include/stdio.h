...
#else
# ifdef __REDIRECT
extern FILE *__REDIRECT (fopen, ( char * __filename,
				  char * __modes), fopen64);
extern FILE *__REDIRECT (freopen, ( char * __filename,
				    char * __modes,
				   FILE * __stream), freopen64);
# else
...
__END_NAMESPACE_STD
#ifdef __USE_LARGEFILE64
extern FILE *fopen64 ( char * __filename,
		       char * __modes);
extern FILE *freopen64 ( char * __filename,
			 char * __modes,
			FILE * __stream);
#endif
...
/* Write formatted output to stdout from argument list ARG.
   ...
   This function is a possible cancellation point and therefore not
   marked with .  */
extern int vprintf ( char * __format, _G_va_list __arg);
/* Write formatted output to S from argument list ARG.  */
...
extern int vsnprintf (char * __s, size_t __maxlen,
		       char * __format, _G_va_list __arg)
      ;
__END_NAMESPACE_C99
#endif
...
extern int vasprintf (char ** __ptr,  char * __f,
		      _G_va_list __arg)
      ;
...
/* Write formatted output to a file descriptor.
   ...
   therefore not marked with .  */
extern int vdprintf (int __fd,  char * __fmt,
		     _G_va_list __arg)
     ;
...
/* Read formatted input from S into argument list ARG.
   ...
   This function is a possible cancellation point and therefore not
   marked with .  */
extern int vfscanf (FILE * __s,  char * __format,
		    _G_va_list __arg)
      ;
...
/* Read formatted input from stdin into argument list ARG.
   ...
   This function is a possible cancellation point and therefore not
   marked with .  */
extern int vscanf ( char * __format, _G_va_list __arg)
      ;

/* Read formatted input from S into argument list ARG.  */
extern int vsscanf ( char * __s,
		     char * __format, _G_va_list __arg)
      ;
__END_NAMESPACE_C99
#endif /* Use ISO C9x.  */
...
/* Read up to (and including) a DELIMITER from STREAM into *LINEPTR
   ...
   or due to the implementation they are cancellation points and
   therefore not marked with .  */
extern _IO_ssize_t __getdelim (char ** __lineptr,
			       size_t * __n, int __delimiter,
			       FILE * __stream) ;
extern _IO_ssize_t getdelim (char ** __lineptr,
			     size_t * __n, int __delimiter,
			     FILE * __stream) ;
...
/* This function does the same as `fputs' but does not lock the stream.
   ...
   or due to the implementation it is a cancellation point and
   therefore not marked with .  */
extern int fputs_unlocked ( char * __s,
			   FILE * __stream);
#endif
...
#else
# ifdef __REDIRECT
extern int __REDIRECT (fgetpos, (FILE * __stream,
				 fpos_t * __pos), fgetpos64);
extern int __REDIRECT (fsetpos,
		       (FILE *__stream,  fpos_t *__pos), fsetpos64);
# else
