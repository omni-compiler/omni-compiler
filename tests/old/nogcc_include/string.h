...
extern int strcoll_l ( char *__s1,  char *__s2, __locale_t __l)
...
/* Again versions of a few functions which use the given locale instead
   of the global one.  */
extern int strcasecmp_l ( char *__s1,  char *__s2,
			 __locale_t __loc)
     __THROW __attribute_pure__ __nonnull ((1, 2, 3));
...
extern int strverscmp ( char *__s1,  char *__s2)
     __THROW __attribute_pure__ __nonnull ((1, 2));
...
extern char *__stpcpy (char * __dest,  char * __src)
     __THROW __nonnull ((1, 2));
...
/* Return the file name within directory of FILENAME.  We don't
   ...
   available.  */
extern char *basename ( char *__filename) __THROW __nonnull ((1));
# endif
#endif
