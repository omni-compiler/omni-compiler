...
extern int settimeofday ( struct timeval *__tv,
...
/* Adjust the current time of day by the amount in DELTA.
   ...
   This call is restricted to the super-user.  */
extern int adjtime ( struct timeval *__delta,
...
extern int futimes (int __fd,  struct timeval __tvp[2]) __THROW;
#endif
...
extern int futimesat (int __fd,  char *__file,
		       struct timeval __tvp[2]) __THROW;
#endif
