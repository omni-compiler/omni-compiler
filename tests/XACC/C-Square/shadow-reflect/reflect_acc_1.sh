...
mpirun_rsh -np $NP -hostfile $PBS_NODEFILE MV2_ENABLE_AFFINITY=0 CUDA_VISIBLE_DEVICES=0 MV2_USE_GPUDIRECT_GDRCOPY=0 numactl --cpunodebind=0 --localalloc ./reflect_acc_1.x