...
#PBS -A XMPTCA
#PBS -q tcaq
#PBS -l select=1:ncpus=1:host=tca-0001-eth0+1:ncpus=1:host=tca-0002-eth0+1:ncpus=1:host=tca-0003-eth0+1:ncpus=1:host=tca-0004-eth0
NP=4
...
cd $PBS_O_WORKDIR
mpirun_rsh -np $NP -hostfile $PBS_NODEFILE MV2_ENABLE_AFFINITY=0 MV2_SHOW_CPU_BINDING=1 numactl --cpunodebind=0 --localalloc ./reflect_acc_2_dup_1.x
