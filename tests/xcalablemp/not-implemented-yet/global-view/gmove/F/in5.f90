...
!$xmp task on p(1,1)
!$xmp gmove in
      b2(1:250,1:200) = b1(251:500,751:950)  ! p(2,3)
!$xmp end task

!$xmp task on p(2,2)
!$xmp gmove in
      a2(251:500,701:900) = a1(501:750,1:200) ! p(3,1)
!$xmp end task

!$xmp task on p(3,3)
!$xmp gmove in
      c2(501:750,751:950) = c1(751:1000,701:900) ! p(4,2)
!$xmp end task
...
!$xmp loop (i,j) on t3(i,j)
      ...
      print *, xmp_node_num(), 'testp082.f ', result
