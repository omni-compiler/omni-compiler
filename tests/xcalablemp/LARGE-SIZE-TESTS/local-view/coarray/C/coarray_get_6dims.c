			  ...
			  for(start[4]=0;start[4]<2;start[4]++){
				...
				for(start[5]=0;start[5]<2;start[5]++){
				  for(len[5]=1;len[5]<=SIZE;len[5]++){
					...
					if(xmp_node_num() == 1){
					  a[start[0]:len[0]:stride[0]][start[1]:len[1]:stride[1]][start[2]:len[2]:stride[2]][start[3]:len[3]:stride[3]][start[4]:len[4]:stride[4]][start[5]:len[5]:stride[5]] 
					    = b[start[0]:len[0]:stride[0]][start[1]:len[1]:stride[1]][start[2]:len[2]:stride[2]][start[3]:len[3]:stride[3]][start[4]:len[4]:stride[4]][start[5]:len[5]:stride[5]]:[2];
						...
						for(int m=0;m<len[3];m++){
						  ...
						  for(int n=0;n<len[4];n++){
						    ...
						    for(int p=0;p<len[5];p++){
						      ...
						      if(a[position0][position1][position2][position3][position4][position5] != 2){
