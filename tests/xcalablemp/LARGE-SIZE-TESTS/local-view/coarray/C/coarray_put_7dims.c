					...
					for(len[6]=1;len[6]<=SIZE;len[6]++){
					  for(stride[6]=1;stride[6]<4;stride[6]++){
						...
						for(int j=0;j<SIZE;j++)
					      ...
					      if(xmp_node_num() == 1){
						a[start[0]:len[0]:stride[0]][start[1]:len[1]:stride[1]][start[2]:len[2]:stride[2]][start[3]:len[3]:stride[3]][start[4]:len[4]:stride[4]][start[5]:len[5]:stride[5]][start[6]:len[6]:stride[6]]:[2]
						  = b[start[0]:len[0]:stride[0]][start[1]:len[1]:stride[1]][start[2]:len[2]:stride[2]][start[3]:len[3]:stride[3]][start[4]:len[4]:stride[4]][start[5]:len[5]:stride[5]][start[6]:len[6]:stride[6]];
					      }
							...
							for(int n=0;n<len[4];n++){
							  ...
							  for(int p=0;p<len[5];p++){
							    ...
							    for(int q=0;q<len[6];q++){
							      ...
							      if(a[position0][position1][position2][position3][position4][position5][position6] != 1){
