...
# 25 "putget-2NGB.f90"
 IF ( me == 1 ) THEN
  CALL xmpf_coarray_put_array ( xmpf_descptr_a2d2 , a2d2 ( 1 , 1 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a2d2 , 1 ,&
   int ( ( - xmpf_coarray_get0d ( xmpf_descptr_a2d2 , a2d2 ( 1 , 2 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a2d2 , 1 ,&
   3 ) , 0 ) ) ) ) , reshape ( (/ 11_2 , 21_2 , 31_2 , 12_2 , 22_2 , 32_2 , 13_2 , 23_2 , 33_2 , 14_2 , 24_2 , 34_2 , 15_2 , 25_2&
   , 35_2 , 16_2 , 26_2 , 36_2 , 17_2 , 27_2 , 37_2 , 18_2 , 28_2 , 38_2 /) , (/ 3 , 8 /) ) , 0 , 2 , a2d2 ( 2 , 1 ) , 3 , a2d2 (&
   1 , 2 ) , max ( int ( ( - xmpf_coarray_get0d ( xmpf_descptr_a2d2 , a2d2 ( 4 , 2 ) , 2 , xmpf_coarray_get_image_index (&
   xmpf_descptr_a2d2 , 1 , 3 ) , 0 ) ) ) , 0 ) )
 END IF
# 36 "putget-2NGB.f90"
 CALL xmpf_sync_all ( )
# 39 "putget-2NGB.f90"
