...
# 16 "putget-4.f90"
 CALL xmpf_sync_all ( )
 CALL xmpf_coarray_put_array ( xmpf_descptr_aa , aa ( 3 ) , 4 , xmpf_coarray_get_image_index ( xmpf_descptr_aa , 1 , 1 ) , (/ 555&
  , 666 /) , 1 , 1 , aa ( 4 ) , max ( xmpf_coarray_get0d ( xmpf_descptr_aa , aa ( 6 ) , 4 , xmpf_coarray_get_image_index (&
  xmpf_descptr_aa , 1 , 3 ) , 0 ) - 2 , 0 ) )
# 22 "putget-4.f90"
 CALL xmpf_sync_all ( )
# 25 "putget-4.f90"
 nerr = 0
