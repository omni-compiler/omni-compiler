...
# 11 "nest.f90"
 CALL xmpf_sync_all ( )
# 14 "nest.f90"
 tmp ( 2 : 6 ) = xmpf_coarray_get1d ( xmpf_descptr_a1d1 , a1d1 ( 2 ) , 4 , xmpf_coarray_get_image_index ( xmpf_descptr_a1d1 , 1 ,&
  xmpf_coarray_get0d ( xmpf_descptr_a1d1 , a1d1 ( 1 ) , 4 , xmpf_coarray_get_image_index ( xmpf_descptr_a1d1 , 1 , 3 ) , 0 ) ) , 1&
  , a1d1 ( 3 ) , max ( xmpf_coarray_get0d ( xmpf_descptr_a1d1 , a1d1 ( 3 ) , 4 , xmpf_coarray_get_image_index ( xmpf_descptr_a1d1&
  , 1 , 2 ) , 0 ) - 1 , 0 ) )
# 15 "nest.f90"
 CALL xmpf_sync_all ( )
# 18 "nest.f90"
...
SUBROUTINE xmpf_traverse_coarraysize_1xmpf_main ( )
 ...
 CALL xmpf_coarray_count_size ( 10 , 4 )
...
SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 ...
 CALL xmpf_coarray_share_pool ( xmpf_descptr_a1d1 , xmpf_crayptr_a1d1 , 10 , 4 ,"a1d1" , 4 )
