...
# 23 "a1d1-4.f90"
 IF ( me == 1 ) THEN
# 24 "a1d1-4.f90"
  b ( 1 : 7 ) = xmpf_coarray_get1d ( xmpf_descptr_a , a ( 1 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 2 , 2 , 1 ) ,&
   1 , a ( 2 ) , 7 )
 END IF
# 27 "a1d1-4.f90"
 CALL xmpf_sync_all ( )
...
# 36 "a1d1-4.f90"
   IF ( jval /= ival ) THEN
    WRITE ( unit = * , fmt = 101 ) i , me , jval , ival
# 38 "a1d1-4.f90"
    nerr = nerr + 1
   END IF
  END DO
...
# 43 "a1d1-4.f90"
   IF ( b ( i ) /= ( - 1234 ) ) THEN
    WRITE ( unit = * , fmt = 101 ) i , me , b ( i ) , (-1234)
# 45 "a1d1-4.f90"
    nerr = nerr + 1
   END IF
  END DO
...
00102 &
# 70 "a1d1-4.f90"
 FORMAT ("me=",i0," a=",10(i0,","))
# 71 "a1d1-4.f90"
00103 &
# 71 "a1d1-4.f90"
 FORMAT ("me=",i0," b=",10(i0,","))
99999 &
 CONTINUE
