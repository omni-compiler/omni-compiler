...
# 3 "a6d3-1.f90"
 INTEGER :: a2 ( 1 : 10 , 1 : 1 , 1 : 20 , 0 : 9 , 1 : 21 , 1 : 2 )
 INTEGER :: me
...
# 1763 "xmp_lib_coarray_get.h"
 ...
 END INTERFACE
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_a2
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_a2
...
# 37 "a6d3-1.f90"
 IF ( me == 2 ) THEN
# 38 "a6d3-1.f90"
  a2 ( 1 : 10 : 2 , 1 : 1 , 1 : 10 , 1 , 1 , 1 ) = 3 + xmpf_coarray_get3d ( xmpf_descptr_a2 , a2 ( 1 , 1 , 1 , 2 , 2 , 2 ) , 4 ,&
   xmpf_coarray_get_image_index ( xmpf_descptr_a2 , 1 , 1 ) , 3 , a2 ( 2 , 1 , 1 , 2 , 2 , 2 ) , 5 , a2 ( 1 , 1 , 1 , 3 , 2 , 2 )&
   , 1 , a2 ( 1 , 1 , 1 , 2 , 3 , 2 ) , 10 ) * 2
 END IF
# 41 "a6d3-1.f90"
 CALL xmpf_sync_all ( )
# 44 "a6d3-1.f90"
...
# 56 "a6d3-1.f90"
     ival = 3 + ival * 2
# 57 "a6d3-1.f90"
     IF ( a2 ( i * 2 - 1 , j , k , 1 , 1 , 1 ) /= ival ) THEN
      WRITE ( unit = * , fmt = 101 ) i * 2 - 1 , j , k , 1 , 1 , 1 , me , a2 ( i * 2 - 1 , j , k , 1 , 1 , 1 ) , ival
# 59 "a6d3-1.f90"
      nerr = nerr + 1
     END IF
# 61 "a6d3-1.f90"
    ...
    DO i3 = 1 , 20 , 1
     DO i4 = 0 , 9 , 1
      DO i5 = 1 , 21 , 1
       DO i6 = 1 , 2 , 1
# 73 "a6d3-1.f90"
        IF ( a2 ( i1 , i2 , i3 , i4 , i5 , i6 ) /= ival ) THEN
        WRITE ( unit = * , fmt = 101 ) i1 , i2 , i3 , i4 , i5 , i6 , me , a2 ( i1 , i2 , i3 , i4 , i5 , i6 ) , ival
# 75 "a6d3-1.f90"
        nerr = nerr + 1
        END IF
       END DO
...
00101 &
# 92 "a6d3-1.f90"
 FORMAT ("a2(",i0,",",i0,",",i0,",",i0,",",i0,",",i0,")[",i0,"]=",i0," should be ",i0)
99999 &
 CONTINUE
...
SUBROUTINE xmpf_traverse_coarraysize_1xmpf_main ( )
 ...
 CALL xmpf_coarray_count_size ( 84000 , 4 )
END SUBROUTINE xmpf_traverse_coarraysize_1xmpf_main

SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 INTEGER ( KIND= 8 ) :: xmpf_descptr_a2
 EXTERNAL xmpf_coarray_share_pool
 INTEGER ( KIND= 8 ) :: xmpf_crayptr_a2
 EXTERNAL xmpf_coarray_set_coshape
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_a2
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_a2

 CALL xmpf_coarray_share_pool ( xmpf_descptr_a2 , xmpf_crayptr_a2 , 84000 , 4 ,"a2" , 2 )
 CALL xmpf_coarray_set_coshape ( xmpf_descptr_a2 , 1 , 1 )
