...
# 25 "a1d1-1.f90"
 IF ( me == 1 ) THEN
# 26 "a1d1-1.f90"
  b ( 11 : 44 ) = xmpf_coarray_get1d ( xmpf_descptr_a , a ( 1 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 1 , 2 ) , 1&
   , a ( 4 ) , 34 )
 ELSE
# 27 "a1d1-1.f90"
  IF ( me == 3 ) THEN
...
# 38 "a1d1-1.f90"
  IF ( a ( i ) /= nval ) THEN
   WRITE ( unit = * , fmt = 101 ) i , me , a ( i ) , nval
# 40 "a1d1-1.f90"
   nerr = nerr + 1
  END IF
 END DO
...
# 46 "a1d1-1.f90"
  ...
  ELSE
# 47 "a1d1-1.f90"
   IF ( me == 3 .AND. i >= 11 .AND. i <= 44 ) THEN
# 48 "a1d1-1.f90"
    nval = a ( i * 3 - 32 )
   ELSE
# 50 "a1d1-1.f90"
...
# 52 "a1d1-1.f90"
  IF ( b ( i ) /= nval ) THEN
   WRITE ( unit = * , fmt = 102 ) i , me , b ( i ) , nval
# 54 "a1d1-1.f90"
   nerr = nerr + 1
  END IF
 END DO
...
00101 &
# 58 "a1d1-1.f90"
 FORMAT ("a(",i0,")[",i0,"]=",i0," should be ",i0)
# 59 "a1d1-1.f90"
00102 &
# 59 "a1d1-1.f90"
...
SUBROUTINE xmpf_traverse_coarraysize_1xmpf_main ( )
 ...
 CALL xmpf_coarray_count_size ( 100 , 8 )
...
SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 ...
 CALL xmpf_coarray_share_pool ( xmpf_descptr_a , xmpf_crayptr_a , 100 , 8 ,"a" , 1 )
