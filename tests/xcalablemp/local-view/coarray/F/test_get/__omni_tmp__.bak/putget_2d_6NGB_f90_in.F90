...
# 14 "putget-6NGB.f90"
 IF ( me == 2 ) THEN
  CALL xmpf_coarray_put_array ( xmpf_descptr_a1d1 , a1d1 ( 2 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a1d1 , 1 , 3 ) ,&
   tmp ( 2 : 6 ) , 0 , 1 , a1d1 ( 3 ) , max ( xmpf_coarray_get0d ( xmpf_descptr_a1d1 , a1d1 ( 3 ) , 2 ,&
   xmpf_coarray_get_image_index ( xmpf_descptr_a1d1 , 1 , 2_2 ) , 0 ) - 1 , 0 ) )
 END IF
# 15 "putget-6NGB.f90"
 CALL xmpf_sync_all ( )
# 18 "putget-6NGB.f90"
...
# 25 "putget-6NGB.f90"
  IF ( a1d1 ( i ) /= ival ) THEN
   WRITE ( unit = * , fmt = 101 ) i , me , a1d1 ( i ) , ival
# 27 "putget-6NGB.f90"
   nerr = nerr + 1
  END IF
 END DO
...
00101 &
# 31 "putget-6NGB.f90"
 FORMAT ("a1d1(",i0,")[",i0,"]=",i0," should be ",i0)
# 33 "putget-6NGB.f90"
 IF ( nerr == 0 ) THEN
# 34 "putget-6NGB.f90"
  PRINT '("[",i0,"] OK")' , me
