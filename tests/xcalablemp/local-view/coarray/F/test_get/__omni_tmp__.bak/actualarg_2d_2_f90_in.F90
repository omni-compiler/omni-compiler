...
# 30 "actualarg-2.f90"
 IF ( me == 1 ) THEN
# 33 "actualarg-2.f90"
  CALL foo ( 2 , xmpf_coarray_get0d ( xmpf_descptr_a , a ( 3 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 2 , 1 , 2 ) ,&
   0 ) , 1 , b ( xmpf_coarray_get0d ( xmpf_descptr_a , a ( 5 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 2 , 2 , 1 ) ,&
   0 ) ) )
 END IF
# 36 "actualarg-2.f90"
 CALL xmpf_sync_all ( )
