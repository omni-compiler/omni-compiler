...
# 2 "actualarg-3.f90"
 INTEGER :: n3
# 3 "actualarg-3.f90"
 INTEGER ( KIND= 8 ) :: n2 ( 1 : 3 )
 INTEGER :: xmp_size_array ( 0 : 15 , 0 : 6 )
 COMMON / XMP_COMMON / xmp_size_array

 CALL xmpf_foo ( n1 , n2 , n3 , n4 )
99999 &
 CONTINUE

CONTAINS
 SUBROUTINE xmpf_foo ( n1 , n2 , n3 , n4 )
  INTEGER :: n1
  INTEGER ( KIND= 8 ) :: n4
  INTEGER :: n3
  INTEGER ( KIND= 8 ) :: n2 ( 1 : 3 )
...
# 4 "actualarg-3.f90"
 ...
 99999 &
  CONTINUE
 END SUBROUTINE xmpf_foo

END SUBROUTINE foo

SUBROUTINE xmpf_main ( )
# 11 "actualarg-3.f90"
 INTEGER ( KIND= 8 ) :: b ( 1 : 10 )
 EXTERNAL xmpf_traverse_initcoarray_1xmpf_main

# 11 "actualarg-3.f90"
 INTEGER ( KIND= 8 ) :: a ( 1 : 10 )
...
# 30 "actualarg-3.f90"
 IF ( me == 1 ) THEN
# 33 "actualarg-3.f90"
  CALL foo ( 2 , a ( 7 : xmpf_coarray_get0d ( xmpf_descptr_a , a ( 3 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 2 , 1&
   , 2 ) , 0 ) ) , 1 , b ( xmpf_coarray_get0d ( xmpf_descptr_a , a ( 5 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 2 ,&
   2 , 1 ) , 0 ) ) )
 END IF
# 36 "actualarg-3.f90"
 CALL xmpf_sync_all ( )
...
# 48 "actualarg-3.f90"
  IF ( b ( i ) /= ival ) THEN
   WRITE ( unit = * , fmt = 101 ) i , me , b ( i ) , ival
# 50 "actualarg-3.f90"
   nerr = nerr + 1
  END IF
 END DO
...
00101 &
# 61 "actualarg-3.f90"
 FORMAT ("b(",i0,")[",i0,"]=",i0," should be ",i0)
99999 &
 CONTINUE
...
SUBROUTINE xmpf_traverse_coarraysize_1xmpf_main ( )
 ...
 CALL xmpf_coarray_count_size ( 10 , 8 )
...
SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 ...
 CALL xmpf_coarray_share_pool ( xmpf_descptr_a , xmpf_crayptr_a , 10 , 8 ,"a" , 1 )
 CALL xmpf_coarray_set_coshape ( xmpf_descptr_a , 2 , 1 , 2 , 1 )
