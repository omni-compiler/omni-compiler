SUBROUTINE xmpf_main ( )
 INTEGER ( KIND= 8 ) :: xmpf_descptr_c5
 EXTERNAL xmpf_traverse_initcoarray_1xmpf_main
# 3 "cn1-1NGB.f90"
 CHARACTER ( LEN= 5 ) :: c5 ( 1 : 4 )
# 4 "cn1-1NGB.f90"
 CHARACTER ( LEN= 9 ) :: c3 ( 1 : 10 )
...
# 1763 "xmp_lib_coarray_get.h"
 ...
 END INTERFACE
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_c5
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_c5
...
# 32 "cn1-1NGB.f90"
 IF ( me == 2 ) THEN
# 33 "cn1-1NGB.f90"
  c3 ( 9 ) = xmpf_coarray_get0d ( xmpf_descptr_c5 , c5 ( 3 ) , 5 , xmpf_coarray_get_image_index ( xmpf_descptr_c5 , 1 , 1 ) , 0 )&
   // xmpf_coarray_get0d ( xmpf_descptr_c5 , c5 ( 2 ) , 5 , xmpf_coarray_get_image_index ( xmpf_descptr_c5 , 1 , 3 ) , 0 )
 END IF
# 35 "cn1-1NGB.f90"
 CALL xmpf_sync_all ( )
# 38 "cn1-1NGB.f90"
...
# 42 "cn1-1NGB.f90"
   IF ( c3 ( i ) /="HappyNewY" ) THEN
    WRITE ( unit = * , fmt = 101 ) i , me , c3 ( i ) ,"HappyNewY"
# 44 "cn1-1NGB.f90"
    nerr = nerr + 1
   END IF
  ELSE
# 47 "cn1-1NGB.f90"
   IF ( c3 ( i ) /="MerryXmas" ) THEN
    WRITE ( unit = * , fmt = 101 ) i , me , c3 ( i ) ,"MerryXmas"
# 49 "cn1-1NGB.f90"
    nerr = nerr + 1
   END IF
  END IF
...
SUBROUTINE xmpf_traverse_coarraysize_1xmpf_main ( )
 ...
 CALL xmpf_coarray_count_size ( 4 , 5 )
...
SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 ...
 EXTERNAL xmpf_coarray_share_pool
 EXTERNAL xmpf_coarray_set_coshape
 INTEGER ( KIND= 8 ) :: xmpf_crayptr_c5
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_c5
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_c5

 CALL xmpf_coarray_share_pool ( xmpf_descptr_c5 , xmpf_crayptr_c5 , 4 , 5 ,"c5" , 2 )
 CALL xmpf_coarray_set_coshape ( xmpf_descptr_c5 , 1 , 1 )
