...
# 1 "actualarg.f90"
 ...
 XMP_dummy0 = xmpf_foo ( n1 , n2 , n3 )
99999 &
 CONTINUE

CONTAINS
 FUNCTION xmpf_foo ( n1 , n2 , n3 )
  INTEGER :: n1
  INTEGER :: n3
  INTEGER ( KIND= 8 ) :: n2
...
# 30 "actualarg.f90"
 IF ( me == 1 ) THEN
# 33 "actualarg.f90"
  b ( xmpf_coarray_get0d ( xmpf_descptr_a , a ( 5 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 2 , 2 , 1 ) , 0 ) ) =&
   foo ( 2 , xmpf_coarray_get0d ( xmpf_descptr_a , a ( 3 ) , 8 , xmpf_coarray_get_image_index ( xmpf_descptr_a , 2 , 1 , 2 ) , 0 )&
   , 1 )
 END IF
# 36 "actualarg.f90"
 CALL xmpf_sync_all ( )
