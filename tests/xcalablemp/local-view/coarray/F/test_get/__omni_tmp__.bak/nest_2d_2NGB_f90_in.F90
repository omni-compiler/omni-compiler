...
# 17 "xmp_lib.h"
 ...
 INTEGER :: nerr
 POINTER ( xmpf_crayptr_a1d1 , a1d1 )
 INTEGER :: i
...
# 17 "xmp_lib.h"
 ...
 INTEGER ( KIND= 8 ) :: xmpf_descptr_a1d1
# 2 "nest-2NGB.f90"
 INTEGER ( KIND= 2 ) :: tmp ( 1 : 10 )
 INTEGER :: me
...
# 1763 "xmp_lib_coarray_get.h"
 ...
 END INTERFACE
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_a1d1
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_a1d1
...
# 11 "nest-2NGB.f90"
 CALL xmpf_sync_all ( )
# 14 "nest-2NGB.f90"
 tmp ( 2 : 6 ) = xmpf_coarray_get1d ( xmpf_descptr_a1d1 , a1d1 ( 2 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a1d1 , 1 ,&
  xmpf_coarray_get0d ( xmpf_descptr_a1d1 , a1d1 ( 1 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a1d1 , 1 , 3 ) , 0 ) ) , 1&
  , a1d1 ( 3 ) , max ( xmpf_coarray_get0d ( xmpf_descptr_a1d1 , a1d1 ( 3 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a1d1&
  , 1 , 2 ) , 0 ) - 1 , 0 ) )
# 15 "nest-2NGB.f90"
 CALL xmpf_sync_all ( )
# 18 "nest-2NGB.f90"
...
# 25 "nest-2NGB.f90"
  IF ( tmp ( i ) /= ival ) THEN
   WRITE ( unit = * , fmt = 101 ) i , me , tmp ( i ) , ival
# 27 "nest-2NGB.f90"
   nerr = nerr + 1
  END IF
 END DO
...
00101 &
# 31 "nest-2NGB.f90"
 FORMAT ("tmp(",i0,")[",i0,"]=",i0," should be ",i0)
# 33 "nest-2NGB.f90"
 IF ( nerr == 0 ) THEN
# 34 "nest-2NGB.f90"
  PRINT '("[",i0,"] OK")' , me
...
SUBROUTINE xmpf_traverse_coarraysize_1xmpf_main ( )
 ...
 CALL xmpf_coarray_count_size ( 10 , 2 )
...
SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 ...
 INTEGER ( KIND= 8 ) :: xmpf_descptr_a1d1
 EXTERNAL xmpf_coarray_set_coshape
 INTEGER ( KIND= 8 ) :: xmpf_crayptr_a1d1
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_a1d1
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_a1d1

 CALL xmpf_coarray_share_pool ( xmpf_descptr_a1d1 , xmpf_crayptr_a1d1 , 10 , 2 ,"a1d1" , 4 )
 CALL xmpf_coarray_set_coshape ( xmpf_descptr_a1d1 , 1 , 1 )
