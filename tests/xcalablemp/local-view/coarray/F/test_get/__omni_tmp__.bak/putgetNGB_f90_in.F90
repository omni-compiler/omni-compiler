SUBROUTINE xmpf_main ( )
 ...
 EXTERNAL xmpf_coarray_put_array
...
# 5 "putgetNGB.f90"
 ...
 INTEGER ( KIND= 8 ) :: xmpf_descptr_a2d2
# 17 "xmp_lib.h"
 INTEGER :: num_images
 EXTERNAL num_images
 EXTERNAL xmpf_coarray_share_pool
# 3 "putgetNGB.f90"
 INTEGER ( KIND= 2 ) :: a2d2 ( 1 : 10 , 1 : 8 )
 INTEGER :: me
...
# 4 "xmp_lib.h"
 ...
 END TYPE xmp_desc
 INTEGER :: i1
 POINTER ( xmpf_crayptr_a2d2 , a2d2 )
...
# 1763 "xmp_lib_coarray_get.h"
 ...
 END INTERFACE
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_a2d2
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_a2d2
...
# 25 "putgetNGB.f90"
 IF ( me == 1 ) THEN
  CALL xmpf_coarray_put_array ( xmpf_descptr_a2d2 , a2d2 ( 1 , 1 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a2d2 , 1 , (&
   - xmpf_coarray_get0d ( xmpf_descptr_a2d2 , a2d2 ( 1 , 2 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a2d2 , 1 , 3 ) , 0&
   ) ) ) , reshape ( (/ 11_2 , 21_2 , 31_2 , 12_2 , 22_2 , 32_2 , 13_2 , 23_2 , 33_2 , 14_2 , 24_2 , 34_2 , 15_2 , 25_2 , 35_2 ,&
   16_2 , 26_2 , 36_2 , 17_2 , 27_2 , 37_2 , 18_2 , 28_2 , 38_2 /) , (/ 3 , 8 /) ) + xmpf_coarray_get0d ( xmpf_descptr_a2d2 , a2d2&
   ( 3 , 1 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a2d2 , 1 , 3 ) , 0 ) , 0 , 2 , a2d2 ( 2 , 1 ) , 3 , a2d2 ( 1 , 2 )&
   , max ( ( - xmpf_coarray_get0d ( xmpf_descptr_a2d2 , a2d2 ( 4 , 2 ) , 2 , xmpf_coarray_get_image_index ( xmpf_descptr_a2d2 , 1&
   , 3 ) , 0 ) ) , 0 ) )
 END IF
# 35 "putgetNGB.f90"
 CALL xmpf_sync_all ( )
...
# 46 "putgetNGB.f90"
   ...
   END IF
# 49 "putgetNGB.f90"
   IF ( a2d2 ( i1 , i2 ) /= ival ) THEN
    WRITE ( unit = * , fmt = 101 ) i1 , i2 , me , a2d2 ( i1 , i2 ) , ival
# 51 "putgetNGB.f90"
    nerr = nerr + 1
   END IF
  END DO
...
00101 &
# 63 "putgetNGB.f90"
 FORMAT ("a2d2(",i0,",",i0,")[",i0,"]=",i0," should be ",i0)
99999 &
 CONTINUE
...
SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 ...
 CALL xmpf_coarray_share_pool ( xmpf_descptr_a2d2 , xmpf_crayptr_a2d2 , 80 , 2 ,"a2d2" , 4 )
 CALL xmpf_coarray_set_coshape ( xmpf_descptr_a2d2 , 1 , 1 )
