...
# 1763 "xmp_lib_coarray_get.h"
 ...
 END INTERFACE
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_aa
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_aa
...
# 21 "putget-5.f90"
 CALL xmpf_sync_all ( )
 CALL xmpf_coarray_put_array ( xmpf_descptr_aa , aa ( pepe ( ) ) , 4 , xmpf_coarray_get_image_index ( xmpf_descptr_aa , 1 , 1 ) ,&
  (/ 555 , 666 /) , 1 , 1 , aa ( pepe ( ) + 1 ) , max ( xmpf_coarray_get0d ( xmpf_descptr_aa , aa ( 6 ) , 4 ,&
  xmpf_coarray_get_image_index ( xmpf_descptr_aa , 1 , 3 ) , 0 ) - pepe ( ) + 1 , 0 ) )
# 27 "putget-5.f90"
 CALL xmpf_sync_all ( )
# 30 "putget-5.f90"
 nerr = 0
...
# 43 "putget-5.f90"
  IF ( aa ( i ) /= ival ) THEN
   WRITE ( unit = * , fmt = 101 ) i , me , aa ( i ) , ival
# 45 "putget-5.f90"
   nerr = nerr + 1
  END IF
 END DO
...
00101 &
# 55 "putget-5.f90"
 FORMAT ("aa(",i0,")[",i0,"]=",i0," should be ",i0)
99999 &
 CONTINUE
...
SUBROUTINE xmpf_traverse_initcoarray_1xmpf_main ( )
 ...
 INTEGER ( KIND= 8 ) :: xmpf_descptr_aa
 EXTERNAL xmpf_coarray_set_coshape
 INTEGER ( KIND= 8 ) :: xmpf_crayptr_aa
 COMMON / xmpf_descptr_xmpf_main / xmpf_descptr_aa
 COMMON / xmpf_crayptr_xmpf_main / xmpf_crayptr_aa

 CALL xmpf_coarray_share_pool ( xmpf_descptr_aa , xmpf_crayptr_aa , 10 , 4 ,"aa" , 2 )
 CALL xmpf_coarray_set_coshape ( xmpf_descptr_aa , 1 , 1 )
