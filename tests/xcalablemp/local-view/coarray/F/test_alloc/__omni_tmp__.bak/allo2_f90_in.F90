...
# 17 "xmp_lib.h"
 ...
 INTEGER ( KIND= 8 ) :: xmpf_descptr_aaa
# 32 "xmp_lib.h"
...
# 1347 "xmp_lib_coarray_alloc.h"
 ...
 WRITE ( unit = * , fmt = * )"f" , associated ( aaa )
# 6 "allo2.f90"
 CALL allo ( )
 WRITE ( unit = * , fmt = * )"t" , associated ( aaa )
 WRITE ( unit = * , fmt = * )"size(aaa)=10" , size ( aaa )
# 9 "allo2.f90"
 CALL reallo ( )
 WRITE ( unit = * , fmt = * )"t" , associated ( aaa )
 WRITE ( unit = * , fmt = * )"size(aaa)=100" , size ( aaa )
...
CONTAINS
 SUBROUTINE allo ( )
  EXTERNAL xmpf_coarray_alloc1d
  INTEGER ( KIND= 8 ) :: xmpf_resource_tag
  EXTERNAL xmpf_coarray_set_coshape

  WRITE ( unit = * , fmt = * )"f" , allocated ( aaa )
# 17 "allo2.f90"
  CALL xmpf_coarray_alloc1d ( xmpf_descptr_aaa , aaa , 10 , 4 , xmpf_resource_tag , 1 , 1 , 10 )
# 17 "allo2.f90"
  CALL xmpf_coarray_set_coshape ( xmpf_descptr_aaa , 2 , 1 , 2 , 1 )
  WRITE ( unit = * , fmt = * )"t" , allocated ( aaa )
 99999 &
  CONTINUE
 END SUBROUTINE allo
 ...
 SUBROUTINE reallo ( )
  EXTERNAL xmpf_coarray_alloc1d
  INTEGER ( KIND= 8 ) :: xmpf_resource_tag
  EXTERNAL xmpf_coarray_dealloc1d
  EXTERNAL xmpf_coarray_set_coshape

# 22 "allo2.f90"
  CALL xmpf_coarray_dealloc1d ( xmpf_descptr_aaa , aaa , xmpf_resource_tag )
  WRITE ( unit = * , fmt = * )"f" , allocated ( aaa )
# 24 "allo2.f90"
  CALL xmpf_coarray_alloc1d ( xmpf_descptr_aaa , aaa , 100 , 4 , xmpf_resource_tag , 1 , 1 , 100 )
# 24 "allo2.f90"
  CALL xmpf_coarray_set_coshape ( xmpf_descptr_aaa , 2 , 1 , 4 , 1 )
 99999 &
  CONTINUE
