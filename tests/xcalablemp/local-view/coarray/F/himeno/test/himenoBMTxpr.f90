...
!!!!!!!!!!!!!!
  if (iop(1)==0.and.iop(2)==0.and.iop(3)==0) then
     write(*,*) "mpi (0,0,0) after z"
     write(*,*) p(1:imax,1:jmax,1:kmax)
  endif
  call mpi_barrier(mpi_comm_world,ierr)
  if (iop(1)==1.and.iop(2)==0.and.iop(3)==0) then
     write(*,*) "mpi (1,0,0) after z"
     write(*,*) p(1:imax,1:jmax,1:kmax)
  endif
!!!!!!!!!!!!!!
  if(ndy > 1) then
...
!!!!!!!!!!!!!!
  if (iop(1)==0.and.iop(2)==0.and.iop(3)==0) then
     write(*,*) "mpi (0,0,0) after y"
     write(*,*) p(1:imax,1:jmax,1:kmax)
  endif
  call mpi_barrier(mpi_comm_world,ierr)
  if (iop(1)==1.and.iop(2)==0.and.iop(3)==0) then
     write(*,*) "mpi (1,0,0) after y"
     write(*,*) p(1:imax,1:jmax,1:kmax)
  endif
!!!!!!!!!!!!!!
  if(ndx > 1) then
...
!!!!!!!!!!!!!!
  if (iop(1)==0.and.iop(2)==0.and.iop(3)==0) then
     write(*,*) "mpi (0,0,0) after x"
     write(*,*) p(1:imax,1:jmax,1:kmax)
  endif
  call mpi_barrier(mpi_comm_world,ierr)
  if (iop(1)==1.and.iop(2)==0.and.iop(3)==0) then
     write(*,*) "mpi (1,0,0) after x"
     write(*,*) p(1:imax,1:jmax,1:kmax)
  endif
!!!!!!!!!!!!!!
  return
