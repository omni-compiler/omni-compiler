...
#pragma xmp template ty(0:n-1,0:n-1,0:n-1,0:n-1,0:n-1,0:n-1)
#pragma xmp distribute tx(block,block,block,block,block,block) onto p
#pragma xmp distribute ty(cyclic(2),cyclic(2),cyclic(2),cyclic(2),cyclic(2),cyclic(2)) onto p
#pragma xmp align a[i0][i1][i2][i3][i4][i5] with tx(i0,i1,i2,i3,i4,i5)
#pragma xmp align b[i0][i1][i2][i3][i4][i5] with ty(i0,i1,i2,i3,i4,i5)
