...
!print *,"initialized(",xmp_node_num(),") a="
!!$xmp loop (i,j) on tp(i,j)
!do i=1,10
! do j=1,10
! print *,"(",i,",",j,")",a(i,j)
...
!print *,"initialized(",xmp_node_num(),")v=",v
!call xmp_barrier()

!print *,"initialized(",xmp_node_num(),")mask="
!!$xmp loop (i,j) on tp(i,j)
!do i=1,10
! do j=1,10
!  print *,"(",i,",",j,")",mask(i,j)
...
!print *,"after pack(",xmp_node_num(),") v="
!!$xmp loop on tq(i)
!do i=1,100
! print *,"(",i,")",v(i)
!end do
!call xmp_barrier()
!!print *,"after pack(",xmp_node_num(),") vdash=",vdash
...
call xmp_barrier()
!print *,"after unpack(",xmp_node_num(),") a="
!!$xmp loop (i,j) on tp(i,j)
!do i=1,10
! do j=1,10
!  print *,"(",i,",",j,")",a(i,j)
...
!!$xmp task on q(1)
!print *,"after unpack(",xmp_node_num(),") adash="
!do i=1,10
! do j=1,10
!  print *,"(",i,",",j,")",adash(i,j)
! end do
