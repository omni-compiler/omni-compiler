...
#pragma xmp bcast (a) on p(2:procs-1)
#pragma xmp bcast (b) on p(2:procs-1)
#pragma xmp bcast (c) on p(2:procs-1)
#pragma xmp bcast (aa) on p(2:procs-1)
#pragma xmp bcast (bb) on p(2:procs-1)
#pragma xmp bcast (cc) on p(2:procs-1)
