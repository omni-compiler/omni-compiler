...
#pragma xmp bcast (a) on p[0:procs2][1:2]
#pragma xmp bcast (b) on p[0:procs2][1:2]
#pragma xmp bcast (c) on p[0:procs2][1:2]
#pragma xmp bcast (aa) on p[0:procs2][1:2]
#pragma xmp bcast (bb) on p[0:procs2][1:2]
#pragma xmp bcast (cc) on p[0:procs2][1:2]
  ans = 2;
  if((id >= 2)&&(id <= 3)){
    if(a != ans) result = -1;
