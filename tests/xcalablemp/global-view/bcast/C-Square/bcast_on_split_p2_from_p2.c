...
#pragma xmp bcast (a) from p[k-1][j-1] on p[0:procs2][1:2]
#pragma xmp bcast (b) from p[k-1][j-1] on p[0:procs2][1:2]
#pragma xmp bcast (c) from p[k-1][j-1] on p[0:procs2][1:2]
#pragma xmp bcast (aa) from p[k-1][j-1] on p[0:procs2][1:2]
#pragma xmp bcast (bb) from p[k-1][j-1] on p[0:procs2][1:2]
#pragma xmp bcast (cc) from p[k-1][j-1] on p[0:procs2][1:2]
