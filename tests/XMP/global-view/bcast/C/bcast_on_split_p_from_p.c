...
#pragma xmp bcast (a) from p[j-1] on p[1:procs-2]
#pragma xmp bcast (b) from p[j-1] on p[1:procs-2]
#pragma xmp bcast (c) from p[j-1] on p[1:procs-2]
#pragma xmp bcast (aa) from p[j-1] on p[1:procs-2]
#pragma xmp bcast (bb) from p[j-1] on p[1:procs-2]
#pragma xmp bcast (cc) from p[j-1] on p[1:procs-2]
