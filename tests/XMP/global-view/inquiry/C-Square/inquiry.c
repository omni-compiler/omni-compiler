...
#pragma xmp nodes p1[2]=p[0][0][0:2]
#pragma xmp template t[9][6][16]
#pragma xmp template t1[6]
#pragma xmp template t2[:]
#pragma xmp distribute t[cyclic(2)][cyclic][block] onto p
#pragma xmp distribute t1[gblock(m)] onto p1
#pragma xmp distribute t2[block] onto p1
#pragma xmp align a[i0][i1][i2] with t[i1][i0][i2]
