...
!  real(8) :: u(N1,N2),uu(N1,N2)
  ...
  integer(4), dimension(1) :: node_dims
  integer(4), dimension(2) :: local_lb, local_ub
  integer(4) :: status
...
! !$xmp nodes p(*)
  node_dims(1) = -1
  call xmp_global_nodes(p_desc,1,node_dims,.false.)
...
! !$xmp distribute t(*, block) onto p
  call xmp_dist_template_DUPLICATION(t_desc, 1, status)
