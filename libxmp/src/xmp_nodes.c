...
void _XMP_create_task_nodes(_XMP_nodes_t **n, _XMP_object_ref_t *rp)
{
...
int _XMP_test_task_on_nodes(_XMP_nodes_t *ref_nodes)
{
...
_Bool _XMP_test_task_nocomm(_XMP_object_ref_t *rp)
{
  if (rp->ref_kind == XMP_OBJ_REF_NODES){
