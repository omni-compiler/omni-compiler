...
static void _XMP_conv_comm_set_to_list(_XMP_gmv_desc_t *gmv_desc_org,
  ...
  case 4:
    ...
    for (c[2] = org_comm_set[2]; c[2]; c[2] = c[2]->next){
      SET_I_AND_LEN(2);
    for (c[3] = org_comm_set[3]; c[3]; c[3] = c[3]->next){
      SET_I_AND_LEN(3);
  ...
  case 5:
    ...
    for (c[3] = org_comm_set[3]; c[3]; c[3] = c[3]->next){
      SET_I_AND_LEN(3);
    for (c[4] = org_comm_set[4]; c[4]; c[4] = c[4]->next){
      SET_I_AND_LEN(4);
  ...
  case 6:
    ...
    for (c[4] = org_comm_set[4]; c[4]; c[4] = c[4]->next){
      SET_I_AND_LEN(4);
    for (c[5] = org_comm_set[5]; c[5]; c[5] = c[5]->next){
      SET_I_AND_LEN(5);
  ...
  case 7:
    ...
    for (c[5] = org_comm_set[5]; c[5]; c[5] = c[5]->next){
      SET_I_AND_LEN(5);
    for (c[6] = org_comm_set[6]; c[6]; c[6] = c[6]->next){
      SET_I_AND_LEN(6);
...
void _XMP_gmove_GSECTION_GSCALAR(_XMP_array_t *dst_array, _XMP_array_t *src_array,
  ...
  _XMP_gmove_BCAST_SCALAR2(tmp, src_addr, src_array, src_ref_index);
