...
#define _XMP_POST_REQUEST_SEND_NIC FJMPI_RDMA_LOCAL_NIC2
#define _XMP_POST_REQUEST_RECV_NIC FJMPI_RDMA_LOCAL_NIC3
#define _XMP_POST_REQUEST_INITIAL_TABLE_SIZE 32
#define _XMP_POST_REQUEST_INCREMENT_TABLE_SIZE 512
#define _XMP_POST_REQUEST_NIC_FLAG (FJMPI_RDMA_LOCAL_NIC2 | FJMPI_RDMA_REMOTE_NIC3 | FJMPI_RDMA_REMOTE_NOTICE)
#define _XMP_POST_REQUEST_ID 1
#endif
