...
extern void _XMP_coarray_malloc_set_f(size_t *elmt_size, int *coarray_dims, int *image_dims);
extern void _XMP_coarray_malloc_set(size_t elmt_size, int coarray_dims, int image_dims);
extern void _XMP_coarray_malloc_array_info_f(int *dim, int *size);
extern void _XMP_coarray_malloc_array_info(int dim, int size);
...
extern void _XMP_coarray_rdma_coarray_set_f(int *dim, int *start, int *length, int *stride);
extern void _XMP_coarray_rdma_coarray_set(int dim, int start, int length, int stride);
extern void _XMP_coarray_rdma_array_set_f(int *dim, int *start, int *length, int *stride, int *size, int *distance);
extern void _XMP_coarray_rdma_array_set(int dim, int start, int length, int stride, int size, int distance);
...
extern size_t get_offset(void *, int);
