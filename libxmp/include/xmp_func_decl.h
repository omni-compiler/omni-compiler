...
extern void _XMP_atomic_define_0(void *, size_t, int, size_t);
extern void _XMP_atomic_define_1(void *, size_t, int, int, size_t);
extern void _XMP_atomic_define_2(void *, size_t, int, int, int, size_t);
extern void _XMP_atomic_define_3(void *, size_t, int, int, int, int, size_t);
extern void _XMP_atomic_define_4(void *, size_t, int, int, int, int, int, size_t);
extern void _XMP_atomic_define_5(void *, size_t, int, int, int, int, int, int, size_t);
extern void _XMP_atomic_define_6(void *, size_t, int, int, int, int, int, int, int, size_t);
extern void _XMP_atomic_define_7(void *, size_t, int, int, int, int, int, int, int, int, size_t);
extern void _XMP_atomic_ref_0(void *, size_t, int*, size_t);
extern void _XMP_atomic_ref_1(void *, size_t, int, int*, size_t);
extern void _XMP_atomic_ref_2(void *, size_t, int, int, int*, size_t);
extern void _XMP_atomic_ref_3(void *, size_t, int, int, int, int*, size_t);
extern void _XMP_atomic_ref_4(void *, size_t, int, int, int, int, int*, size_t);
extern void _XMP_atomic_ref_5(void *, size_t, int, int, int, int, int, int*, size_t);
extern void _XMP_atomic_ref_6(void *, size_t, int, int, int, int, int, int, int*, size_t);
extern void _XMP_atomic_ref_7(void *, size_t, int, int, int, int, int, int, int, int*, size_t);
