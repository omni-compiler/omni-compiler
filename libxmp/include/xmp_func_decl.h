...
// xmp_coarray.c
extern void _XMP_init_coarray_STATIC(void **coarray, void *addr, int type, size_t type_size, ...);
extern void _XMP_init_coarray_DYNAMIC(void **coarray, void *addr, int type, size_t type_size, ...);
