...
public class XmcXcodeToXcTranslator {
    ...
    Pair pairs[] = {
        ...
        new Pair("compoundValue", new CompoundValueVisitor()),
        new Pair("compoundValueExpr", new CompoundValueExprVisitor()),
        new Pair("compoundValueAddrExpr", new CompoundValueAddrExprVisitor()),
