...
public class XcodeMLNameTable_F extends XcodeMLNameTable {
	XcodeMLName table[] = {
			...
			new XcodeMLName(Xcode.F_DO_CONCURRENT_STATEMENT, "FdoConcurrentStatement"),
			...
			new XcodeMLName(Xcode.SELECT_TYPE_STATEMENT,
					"selectTypeStatement"),
			new XcodeMLName(Xcode.F_WAIT_STATEMENT, "FwaitStatement"),
			...
			new XcodeMLName(Xcode.F_ERROR_STOP_STATEMENT, "FerrorStopStatement"),
			...
			new XcodeMLName(Xcode.F_FLUSH_STATEMENT, "FflushStatement"),
			...
			new XcodeMLName(Xcode.F_FINAL_PROCEDURE , "finalProcedure" ),
