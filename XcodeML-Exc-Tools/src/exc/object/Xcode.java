...
public enum Xcode
{
    ...
    ARRAY_ADDR                      (  75, 'T', XbcArrayAddr.class, null),
    FUNC_ADDR                       (  76, 'T', XbcFuncAddr.class, XbfFfunction.class),
    MEMBER_REF                      (  77, 'P', XbcMemberRef.class, XbfFmemberRef.class),
    MEMBER_ARRAY_REF                (  78, 'L', XbcMemberArrayRef.class, null),
    MEMBER_ADDR                     (  79, 'L', XbcMemberAddr.class, null),
    MEMBER_ARRAY_ADDR               (  80, 'L', XbcMemberArrayAddr.class, null),
    ARRAY_REF                       (  81, 'L', XbcArrayRef.class, null),
     // L   ARRAY_AREF               
     // -----------------
     // C: Directive
    PRAGMA_LINE                     (  82, 'L', XbcPragma.class, XbfFpragmaStatement.class),
    TEXT                            (  83, 'L', XbcText.class, null),
     // -----------------
     // C: GCC Syntax
    BUILTIN_OP                      (  84, 'L', XbcBuiltinOp.class, null),
    GCC_ATTRIBUTES                  (  85, 'L', XbcGccAttributes.class, null),
    GCC_ATTRIBUTE                   (  86, 'L', XbcGccAttribute.class, null),
    GCC_ASM                         (  87, 'L', XbcGccAsm.class, null),
    GCC_ASM_DEFINITION              (  88, 'L', XbcGccAsmDefinition.class, null),
    GCC_ASM_STATEMENT               (  89, 'L', XbcGccAsmStatement.class, null),
    GCC_ASM_OPERANDS                (  90, 'L', XbcGccAsmOperands.class, null),
    GCC_ASM_OPERAND                 (  91, 'L', XbcGccAsmOperand.class, null),
    GCC_ASM_CLOBBERS                (  92, 'L', XbcGccAsmClobbers.class, null),
    GCC_ALIGN_OF_EXPR               (  93, 'L', XbcGccAlignOfExpr.class, null),
    GCC_MEMBER_DESIGNATOR           (  94, 'L', XbcGccMemberDesignator.class, null),
    GCC_LABEL_ADDR                  (  95, 'L', XbcGccLabelAddr.class, null),
    GCC_COMPOUND_EXPR               (  96, 'L', XbcGccCompoundExpr.class, null),
    GCC_RANGED_CASE_LABEL           (  97, 'L', XbcGccRangedCaseLabel.class, null),
     // -----------------
     // C: XcalableMP Syntax
    SUB_ARRAY_REF                   (  98, 'L', XbcSubArrayRef.class, null),
     // L   SUBA_LOWER_BOUND           
     // L   SUBA_UPPER_BOUND           
     // L   SUBA_STEP                  
    CO_ARRAY_REF                    (  99, 'L', XbcCoArrayRef.class, null),
    CO_ARRAY_ASSIGN_EXPR            ( 100, 'L', XbcCoArrayAssignExpr.class, null),
     // -----------------
     // Fortran: Declaration / Definition
    F_DATA_DECL                     ( 101, 'L', null, XbfFdataDecl.class),
    F_BLOCK_DATA_DEFINITION         ( 102, 'L', null, XbfFblockDataDefinition.class),
    F_ENTRY_DECL                    ( 103, 'L', null, XbfFentryDecl.class),
    F_EXTERN_DECL                   ( 104, 'L', null, XbfExternDecl.class),
    F_EQUIVALENCE_DECL              ( 105, 'L', null, XbfFequivalenceDecl.class),
    F_COMMON_DECL                   ( 106, 'L', null, XbfFcommonDecl.class),
    F_MODULE_DEFINITION             ( 107, 'L', null, XbfFmoduleDefinition.class),
    F_MODULE_PROCEDURE_DECL         ( 108, 'L', null, XbfFmoduleProcedureDecl.class),
    F_INTERFACE_DECL                ( 109, 'L', null, XbfFinterfaceDecl.class),
    F_FORMAT_DECL                   ( 110, 'L', null, XbfFformatDecl.class),
    F_NAMELIST_DECL                 ( 111, 'L', null, XbfFnamelistDecl.class),
    F_STRUCT_DECL                   ( 112, 'L', null, XbfFstructDecl.class),
    F_USE_DECL                      ( 113, 'L', null, XbfFuseDecl.class),
    F_RENAME                        ( 114, 'L', null, XbfRename.class),
    F_RENAMABLE                     ( 115, 'L', null, XbfRenamable.class),
    F_USE_ONLY_DECL                 ( 116, 'L', null, XbfFuseOnlyDecl.class),
    F_STATEMENT_LIST                ( 117, 'L', null, XbfBody.class),
     // -----------------
     // Fortran: Statement
    F_ASSIGN_STATEMENT              ( 118, 'S', null, XbfFassignStatement.class),
    F_POINTER_ASSIGN_STATEMENT      ( 119, 'S', null, XbfFpointerAssignStatement.class),
    F_DO_STATEMENT                  ( 120, 'S', null, XbfFdoStatement.class),
    F_DO_WHILE_STATEMENT            ( 121, 'S', null, XbfFdoWhileStatement.class),
    F_SELECT_CASE_STATEMENT         ( 122, 'S', null, XbfFselectCaseStatement.class),
    F_CASE_LABEL                    ( 123, 'S', null, XbfFcaseLabel.class),
    F_WHERE_STATEMENT               ( 124, 'S', null, XbfFwhereStatement.class),
    F_IF_STATEMENT                  ( 125, 'S', null, XbfFifStatement.class),
    F_CYCLE_STATEMENT               ( 126, 'S', null, XbfFcycleStatement.class),
    F_EXIT_STATEMENT                ( 127, 'S', null, XbfFexitStatement.class),
    F_CONTINUE_STATEMENT            ( 128, 'S', null, XbfContinueStatement.class),
    F_CONTAINS_STATEMENT            ( 129, 'S', null, XbfFcontainsStatement.class),
    F_ALLOCATE_STATEMENT            ( 130, 'S', null, XbfFallocateStatement.class),
    F_BACKSPACE_STATEMENT           ( 131, 'S', null, XbfFbackspaceStatement.class),
    F_CLOSE_STATEMENT               ( 132, 'S', null, XbfFcloseStatement.class),
    F_DEALLOCATE_STATEMENT          ( 133, 'S', null, XbfFdeallocateStatement.class),
    F_END_FILE_STATEMENT            ( 134, 'S', null, XbfFendFileStatement.class),
    F_INQUIRE_STATEMENT             ( 135, 'S', null, XbfFinquireStatement.class),
    F_NULLIFY_STATEMENT             ( 136, 'S', null, XbfFnullifyStatement.class),
    F_OPEN_STATEMENT                ( 137, 'S', null, XbfFopenStatement.class),
    F_PRINT_STATEMENT               ( 138, 'S', null, XbfFprintStatement.class),
    F_READ_STATEMENT                ( 139, 'S', null, XbfFreadStatement.class),
    F_REWIND_STATEMENT              ( 140, 'S', null, XbfFrewindStatement.class),
    F_WRITE_STATEMENT               ( 141, 'S', null, XbfFwriteStatement.class),
    F_PAUSE_STATEMENT               ( 142, 'S', null, XbfFpauseStatement.class),
    F_STOP_STATEMENT                ( 143, 'S', null, XbfFstopStatement.class),
     // -----------------
     // Fortran: Variable Reference
    F_VAR_REF                       ( 144, 'L', null, XbfVarRef.class),
    F_ARRAY_REF                     ( 145, 'L', null, XbfFarrayRef.class),
     // -----------------
     // Unary Expression			
    F_USER_UNARY_EXPR               ( 146, 'U', null, XbfUserUnaryExpr.class),
     // -----------------
     // Fortran: Binary Expression
    F_POWER_EXPR                    ( 147, 'B', null, XbfFpowerExpr.class),
    F_LOG_EQV_EXPR                  ( 148, 'B', null, XbfLogEQVExpr.class),
    F_LOG_NEQV_EXPR                 ( 149, 'B', null, XbfLogNEQVExpr.class),
    F_USER_BINARY_EXPR              ( 150, 'B', null, XbfUserBinaryExpr.class),
     // -----------------
     // Fortran: Character Expression
    F_CHARACTER_REF                 ( 151, 'L', null, XbfFcharacterRef.class),
    F_CONCAT_EXPR                   ( 152, 'L', null, XbfFconcatExpr.class),
     // -----------------
     // Fortran: Constant Expression			
    F_LOGICAL_CONSTATNT             ( 153, 'T', null, XbfFlogicalConstant.class),
    F_CHARACTER_CONSTATNT           ( 154, 'T', null, XbfFcharacterConstant.class),
    F_COMPLEX_CONSTATNT             ( 155, 'L', null, XbfFcomplexConstant.class),
     // -----------------
     // Fortran: Other Expression			
    F_ARRAY_CONSTRUCTOR             ( 156, 'L', null, XbfFarrayConstructor.class),
    F_STRUCT_CONSTRUCTOR            ( 157, 'L', null, XbfFstructConstructor.class),
     // -----------------
     // Fortran: Other Elements
    F_VAR_LIST                      ( 158, 'L', null, XbfVarList.class),
    F_VALUE_LIST                    ( 159, 'L', null, XbfValueList.class),
    F_VALUE                         ( 160, 'L', null, XbfValue.class),
    F_DO_LOOP                       ( 161, 'L', null, XbfFdoLoop.class),
    F_INDEX_RANGE                   ( 162, 'L', null, XbfIndexRange.class),
    F_ALLOC                         ( 163, 'L', null, XbfAlloc.class),
    F_ARRAY_INDEX                   ( 164, 'L', null, XbfArrayIndex.class),
    F_CONDITION                     ( 165, 'L', null, XbfCondition.class),
    F_NAMED_VALUE                   ( 166, 'L', null, XbfNamedValue.class),
    F_NAMED_VALUE_LIST              ( 167, 'L', null, XbfNamedValueList.class),
     // -----------------
     // External Pragma
