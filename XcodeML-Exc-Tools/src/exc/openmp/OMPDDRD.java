 ...
 */
public class OMPDDRD implements XobjectDefVisitor
{
    /* DDRD extension */
    ...
    OMPDDRDrewriteExpr rewriteExpr = new OMPDDRDrewriteExpr();
    ...
    public OMPDDRD(XobjectFile env)
    {
        init(env);
    }
    ...
    public void doDef(XobjectDef d)
    {
		...
		/* keep program (not change subroutine)
